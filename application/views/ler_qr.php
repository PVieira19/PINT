...
<html>
  ...
  <div style="color: #cd1313;"> <h4>QR Code</h4> </div>
       <hr style="background-color:#cd1313;"> 


   <center><video style="border-style: solid;border-color: #cd1313;width: 60%;height: 60%" id="preview"></video></center>
    <h1 id="erro" style="display:none;">Não foram encontradas câmeras</h1>
    <script type="text/javascript">
      ...
      scanner.addListener("scan", function(content) {
        ...
        //arranjar maneira de ver se o utilizador esta logado
      ...
      Instascan.Camera.getCameras()
        .then(function(cameras) {
          if (cameras.length > 0) {
            ...
            if(cameras[1]!=null){
           // alert("tem camera traseira");
            scanner.start(cameras[1]);

            }else{
           // alert("tem camera cara");
            ...
            document.getElementById('erro').style.display="visible";
            console.error("No cameras found.");
          }
        })
        .catch(function(e) {
          console.error(e);
          //console.error("erro de camera");
        });
    </script>
